...
export const profileConfig: ProfileConfig = {
  avatar: 'assets/images/avatar-bydoubaoai.png',  // 图片由豆包基于 AI 技术生成 The picture is generated by Doubao based on AI technology
  name: '半分星',
  ...
  links: [
    {
      ...
      url: 'mailto:pollux_glory@outlook.com',
    },
    {
      name: 'Steam',
